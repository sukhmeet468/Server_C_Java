...
void GenericTCPServer(void)
{
	...
	switch(TCPServerState)
	{
		...
		case SM_LISTENING: // See if anyone is connected to us
			...
			// Process all bytes that we can. This is implemented as a loop, processing up to 
			// sizeof(AppBuffer) bytes at a time. This limits memory usage while maximizing performance.
