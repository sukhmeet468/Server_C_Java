...
extern void LEDTCPServer(void);
extern void TCPToUpperServer(void);
extern void LEDPBServer(void);
...
// KF: start
    ...
    /*(chipkit_pro_mx7_rm.pdf)Button BTN3 is connected to the signal TMS/RA0 on the PIC32 microcontroller. This microcontroller pin is shared
